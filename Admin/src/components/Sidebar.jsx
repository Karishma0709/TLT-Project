            ...
            <aside className='bg-red-500 min-h-full  w-full  max-w-60 customShadow text-white'>
                ...
                <div>
                    <nav className='grid p-4'>
                        ...
                        <Link to={"Prevyearpaperpdf"} className='px-2 py-1 hover:bg-slate-100 hover:text-black hover:font-semibold'>Previou Year Paper Pdf</Link>
                        ...
                        <Link to={"product-upload"} className='px-2 py-1 hover:bg-slate-100 hover:text-black hover:font-semibold'>Product</Link>
