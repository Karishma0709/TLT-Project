            ...
            <form action="#">
              ...
              {/* --------------------- state field ------------------- */}
                ...
                <div className="input-data w-full relative">
                  ...
                  <label className="absolute left-0 bottom-1 text-gray-500 transition-all ps-2 font-medium" for="state">
                  ...
                  >
                    <option value="" className="font-medium">State</option>
                    {statename.map((item,index)=>(<option key={index} value={`${item.name}`} className="text-white">{item.name}</option>))}
                  </select>
